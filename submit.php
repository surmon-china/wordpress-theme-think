...
<div id="content">
<!-- 关于表单样式，请自行调整-->
<form method="post" action="<?php echo $_SERVER["REQUEST_URI"]; ?>" style=" border-top: 4px solid #f60; padding: 15px; margin-top: 5px; background-color: #fff;">
    <div class="shuru">
...
background-color: #eee;">
        ...
        <input type="submit" value="提交" style="cursor: pointer; background-color: #009ad9; font-family: 微软雅黑; color: #ffffff; height: 50px; line-height: 50px; width: 70%; font-size: 16px; float: left;margin-right: 1px;" />
